...
#define _RIIC_SDAO_DELAY_COUNTER_1               (0x00000010UL) /* 1 IIC? cycle */
#define _RIIC_SDAO_DELAY_COUNTER_2               (0x00000020UL) /* 2 IIC? cycle */
#define _RIIC_SDAO_DELAY_COUNTER_3               (0x00000030UL) /* 3 IIC? cycle */
#define _RIIC_SDAO_DELAY_COUNTER_4               (0x00000040UL) /* 4 IIC? cycle */
#define _RIIC_SDAO_DELAY_COUNTER_5               (0x00000050UL) /* 5 IIC? cycle */
#define _RIIC_SDAO_DELAY_COUNTER_6               (0x00000060UL) /* 6 IIC? cycle */
#define _RIIC_SDAO_DELAY_COUNTER_7               (0x00000070UL) /* 7 IIC? cycle */

/*
    I2C Bus Mode Register 3 (RIICnMR3)
*/
/* WAIT (WAIT) */
#define _RIIC_WAIT_NO                            (0x00000000UL) /* Not held period between 9th and 1st clock cycle low. */
...
#define _RIIC_DIGITAL_NF_STAGE_SINGLE            (0x00000000UL) /* Noise of up to one IIC? cycle is filtered out. */
#define _RIIC_DIGITAL_NF_STAGE_2                 (0x00000001UL) /* Noise of up to two IIC? cycles is filtered out. */
#define _RIIC_DIGITAL_NF_STAGE_3                 (0x00000002UL) /* Noise of up to three IIC? cycles is filtered out. */
#define _RIIC_DIGITAL_NF_STAGE_4                 (0x00000003UL) /* Noise of up to four IIC? cycles is filtered out. */
...
Macro definitions
***********************************************************************************************************************/
#define _RIIC_BITRATE_LOW_LEVEL_PERIOD           (0x0000001BUL) /* Bit Rate Low-Level Period */
#define _RIIC_BITRATE_HIGH_LEVEL_PERIOD          (0x00000000UL) /* Bit Rate High-Level Period */
#define _RIIC_RIIC0BRL_DEFAULT_VALUE             (0x000000E0UL) /* RIIC0BRL default value */
#define _RIIC_RIIC0BRH_DEFAULT_VALUE             (0x000000E0UL) /* RIIC0BRH default value */
